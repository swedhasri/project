  ...
  useEffect(() => {
    const fetchEnrollments = async () => {
      ...
      try {
        ...
        const { data } = await axios.get('http://localhost:5000/api/enrollments/myenrollments', config);
        setEnrollments(data);
        setLoading(false);
      } catch (error) {
      ...
      <div className="pt-24 pb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">Keep up the good work. You've learned 35% more this week.</p>
          </div>
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex gap-6">
            ...
            <div className="text-center">
                <p className="text-xs text-gray-500 uppercase font-bold tracking-wide">Completed</p>
                <p className="text-2xl font-bold text-green-600">0</p>
            </div>
            <div className="w-px bg-gray-200"></div>
            <div className="text-center">
                <p className="text-xs text-gray-500 uppercase font-bold tracking-wide">Certificates</p>
